 ...
 *	-	`Сp1`:		~-0.54 to 1.14 - coefficient for pressurre distribution under an airfoil at 10° angle of attack
 *	-	`Сp2`:		~-2.8 to 1.0 - coefficient for pressurre distribution over an airfoil at 10° angle of attack
 *
